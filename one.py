...
import database   # <-- our second module to push data
...
class ExportForm(QWidget):
    def __init__(self):
        ...
        border-radius: 60px;        /* circular if width=height */
        background-color: #f5f6f7;  /* background around image */
    ...
    def initUI(self):
        ...
        header_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)  # center horizontally

        # Logo QLabel
        logo = QLabel()
        pixmap = QPixmap("wwe.jpg")
        if not pixmap.isNull():
            # scale the image to fit inside the QLabel without cropping
        ...
        logo.setAlignment(Qt.AlignmentFlag.AlignCenter)  # center inside the label
        header_layout.addWidget(logo)

        # Company Info Layout
        company_layout = QVBoxLayout()
        company_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)  # center vertically
        ...
        description = QLabel("This is a sample export form. Fill the details below.")
    ...
    def handle_submit(self):
        ...
        if unfilled:
            ...
            # Push to MongoDB using the second module
